...
exports.GoogleModule = GoogleModule = __decorate([
    (0, common_1.Module)({
        providers: [sheets_service_1.GoogleSheetsService, docs_service_1.GoogleDocsService],
        exports: [sheets_service_1.GoogleSheetsService, docs_service_1.GoogleDocsService],
    })
], GoogleModule);
