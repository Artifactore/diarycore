...
exports.LlmModule = LlmModule = __decorate([
    (0, common_1.Module)({
        providers: [llm_service_1.LlmService, transcription_service_1.TranscriptionService],
        exports: [llm_service_1.LlmService, transcription_service_1.TranscriptionService],
    })
], LlmModule);
